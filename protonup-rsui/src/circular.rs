//! Circular loading spinner widget.
//!
//! Based on the Material Design circular progress indicator.
    ...
    Theme: StyleSheet,
{
    ...
    /// Sets the base rotation duration of this [`Circular`].
...
/// The appearance of a [`Circular`] spinner.
